# ---------------------------------------------------------------------------- #
# Title: Assignment06_ToDoListFunctions
...
# CBridge,11.19.2022,Added code to complete Processor class section
# CBridge,11.20.2022,Added code to complete IO class section
# ---------------------------------------------------------------------------- #
...
class IO:
    ...
    def input_task_to_remove():
        ...
        """
        # TODO: Add Code Here!
        task = str(input("Enter the task name to be removed: ")).lower().strip()    # request task from user
        return task
    ...
    def save_reminder():
        ...
        while True:
            ...
            if reminder in ("y", "n"):
                return reminder
            else:       # prompt user for Y or N entry only
...
while True:
    ...
    if choice_str.strip() == '1':  # Add a new Task
        ...
        if IO.save_reminder() == "y":   # Save data to file
            table_lst = Processor.write_data_to_file(file_name=file_name_str, list_of_rows=table_lst)
            print("Data Saved!\n")
            print("Goodbye!")
